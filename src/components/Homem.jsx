    ...
    <Fragment>
                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="hero-header-inner animated zoomIn">
                            ...
                            <h1 className="display-1 mb-5 text-dark">Home and International</h1>
        ...
        <div className="container-fluid sermon py-5">
            <div className="container py-5">
                ...
                <div className="row g-4 justify-content-center">
                    ...
                    <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Gombe State</a>
                   ...
                   <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Plateau State</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                ...
                <h5 className="text-center text-uppercase"><em>International Missionaries</em></h5>
                    <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.1s">
                            <div className="overflow-hidden p-4 pb-0">
                                <img src="assets/img/ai-generated-ga0b3f568f_1920.jpg" className="img-fluid w-100" alt=""/>
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Iraq</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                   ...
                   <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Isreal</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Ukraine</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                   ...
                   <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Morroco</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Iran</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                   ...
                   <div className="col-lg-3 col-xl-4">
                        <div className="sermon-item wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div className="p-4">
                                <a href="/404" className="d-inline-block h4 lh-sm mb-3">Pakistan</a>
                                <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                                aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
